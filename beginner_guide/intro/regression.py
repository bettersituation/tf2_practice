...
pairplot_columns = ['MPG', 'Cylinders', 'Displacement', 'Weight']
sns.pairplot(train_dataset[pairplot_columns], diag_kind='kde')
plt.show()
...
def plot_history(history):
    ...
    plt.plot(hist['epoch'], hist['mse'], label='Train Erorr')
